document.addEventListener("DOMContentLoaded", () => {
  ...
  // Re-render the activity cards and dropdown after any signup or removal
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantItems = participants.length
          ? participants.map((participant) => `
            ...
            `).join("")
          : '<li class="participant-empty">No students have signed up yet.</li>';

        activityCard.innerHTML = `
          <div class="card-header">
            <h4>${name}</h4>
            <span class="participants-badge">${participants.length}/${details.max_participants}</span>
          </div>
